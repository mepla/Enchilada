...
from www.resources.business_reveiws import BusinessReview, BusinessReviews, BusinessReviewsSummary, ChooseBusinessReview
...
def initialize_app():
    ...
    api.add_resource(ChooseBusinessReview, '/businesses/<string:bid>/reviews/<string:rid>/choose')
    api.add_resource(BusinessReviewsSummary, '/businesses/<string:bid>/reviews_summary')
    ...
    api.add_resource(UserNotificationCount, '/users/<string:target_uid>/notifications/count')
    ...
    api.add_resource(UserReviews, '/users/<string:target_uid>/reviews')
